...
namespace Yandex.Music.Api.API
{
    ...
    public class YTrackAPI : YCommonAPI
    {
        ...
        {
            YTrackDownloadInfo mainDownloadResponse = (await GetMetadataForDownloadAsync(storage, trackKey, false))
                .Result
                .OrderByDescending(i => i.BitrateInKbps)
                .First(m => m.Codec == "mp3");
            YStorageDownloadFile storageDownloadResponse = await GetDownloadFileInfoAsync(storage, mainDownloadResponse);
